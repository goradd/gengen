...
//go:generate gengen -c safe_string_string.json  -o ../maps/safestrslicemap.go slice_map.tmpl
...
//go:generate gengen -c safe_string_interface.json  -o ../maps/safeslicemap.go slice_map.tmpl
...
//go:generate gengen -c standard_test.json  -o ../maps/slicemap_test.go string_interface_slice_test.tmpl
//go:generate gengen -c safe_test.json  -o ../maps/safeslicemap_test.go string_interface_slice_test.tmpl
